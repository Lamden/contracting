...
#
#
# @dhaba @wywfalcon @StuartFarmer @raghupc
#
#
# 806
# lines(643
...
#                              "SET DecimalHash:currency:balances:anonymoose 9986.0;SET DecimalHash:currency:balances:stu 83.0;"),
#                             (c2, "SUCC",
#                              "SET DecimalHash:currency:balances:stu 43.0;SET DecimalHash:currency:balances:anonymoose 10026.0;")]
#
...
#         client1.execute_sb(input_hash=input_hash1, contracts=[c1, c2],
#                            completion_handler=self.assert_completion(expected_sbb1_rep, input_hash1))
#         client2.execute_sb(input_hash=input_hash2, contracts=[],
#                            completion_handler=self.assert_completion(expected_sbb2_rep, input_hash2))
#
#         # We must run the future manually, since the event loop is not currently running
...
#                              (c2, "SUCC",
#                               "SET DecimalHash:currency:balances:stu 43.0;SET DecimalHash:currency:balances:anonymoose 10026.0;")]
#         expected_sbb2_rep = [(c3, "SUCC",
#                               "SET DecimalHash:currency:balances:ghu 8985.0;SET DecimalHash:currency:balances:anonymoose 10041.0;"),
#                              (c4, "SUCC",
#                               "SET DecimalHash:currency:balances:tj 7910.0;SET DecimalHash:currency:balances:birb 8090.0;")]
#
#         client1 = SenecaClient(sbb_idx=0, num_sbb=2, loop=loop)
#         client1.metering = False
#         client2 = SenecaClient(sbb_idx=1, num_sbb=2, loop=loop)
...
#         expected_sbb1_1 = [(c1, "SUCC",
#                             "SET DecimalHash:currency:balances:anonymoose 9986.0;SET DecimalHash:currency:balances:stu 83.0;"),
#                            (c2, "SUCC",
#                             "SET DecimalHash:currency:balances:stu 43.0;SET DecimalHash:currency:balances:anonymoose 10026.0;")]
#         expected_sbb2_1 = [(c3, "SUCC",
#                             "SET DecimalHash:currency:balances:ghu 8985.0;SET DecimalHash:currency:balances:anonymoose 10041.0;"),
#                            (c4, "SUCC",
#                             "SET DecimalHash:currency:balances:tj 7910.0;SET DecimalHash:currency:balances:birb 8090.0;")]
#         expected_sbb1_2 = [(c5, "SUCC",
#                             "SET DecimalHash:currency:balances:ethan 7940.0;SET DecimalHash:currency:balances:birb 8150.0;"),
#                            (c6, "SUCC",
#                             "SET DecimalHash:currency:balances:stu 33.0;SET DecimalHash:currency:balances:anonymoose 10051.0;")]
#         expected_sbb2_2 = [
#             (c7, "SUCC", "SET DecimalHash:currency:balances:ghu 8935.0;SET DecimalHash:currency:balances:tj 7960.0;"),
#             (c8, "SUCC",
#              "SET DecimalHash:currency:balances:birb 8050.0;SET DecimalHash:currency:balances:anonymoose 10151.0;")]
#
#         loop = asyncio.new_event_loop()
#         asyncio.set_event_loop(loop)
#
...
#                              "Client with sbb_idx {} has pending_dbs: {}".format(c.sbb_idx, all_input_hashes))
#
#         loop.close()
#
...
#             client1.execute_sb(in_hash, txs,
#                                self.assert_completion(None, in_hash, merge_master=True, client=client1, merge_wait=0))
#         for i, in_hash in enumerate(c2_map):
#             # txs = self._gen_random_contracts(num=NUM_TX, stamps=10 ** 5) if i % 2 == 1 else []
#             txs = self._gen_random_contracts(num=NUM_TX, stamps=10 ** 5) if True else []
#             client2.execute_sb(in_hash, txs,
#                                self.assert_completion(None, in_hash, merge_master=True, client=client2, merge_wait=0))
#
#         # Execute an empty sb at the end
#         client1.execute_sb(input_hash9, [],
#                            self.assert_completion(None, input_hash9, merge_master=True, client=client1, merge_wait=0))
#         client2.execute_sb(input_hash10, [],
#                            self.assert_completion(None, input_hash10, merge_master=True, client=client2, merge_wait=0))
#
#         # Run it all
...
#         client2.metering = False
#
#         client1.execute_sb(input_hash1, contracts=[c1, c2],
#                            completion_handler=self.assert_completion(None, input_hash1))
#         client2.execute_sb(input_hash2, contracts=[c3, c4],
#                            completion_handler=self.assert_completion(None, input_hash2))
#
#         client1.execute_sb(input_hash3, contracts=[c5, c6],
#                            completion_handler=self.assert_completion(None, input_hash3))
#         client2.execute_sb(input_hash4, contracts=[c7, c8],
#                            completion_handler=self.assert_completion(None, input_hash4))
#
#         client1.update_master_db()
#         client2.update_master_db()
#
...
#                                               contract_name=contract_name, func_name='transfer',
#                                               to=MINT_WALLETS['birb'], amount=1)
#
...
#
#         client.execute_sb(input_hash1, contracts=tx1_set,
#                           completion_handler=self.assert_completion(None, input_hash1, merge_master=True,
#                                                                     client=client))
#         client.execute_sb(input_hash2, contracts=tx2_set,
#                           completion_handler=self.assert_completion(None, input_hash2, merge_master=True,
#                                                                     client=client))
#         client.execute_sb(input_hash3, contracts=tx3_set,
#                           completion_handler=self.assert_completion(None, input_hash3, merge_master=True,
#                                                                     client=client))
#         client.execute_sb(input_hash4, contracts=tx4_set,
#                           completion_handler=self.assert_completion(None, input_hash4, merge_master=True,
#                                                                     client=client))
#
#         coros = self._get_futures(
#             OrderedDict({input_hash1: client, input_hash2: client, input_hash3: client, input_hash4: client}))
#         loop.run_until_complete(asyncio.gather(*coros))
#
#         async def _wait_for_things_to_finish():
#             log.notice("Tester waiting for things to finish")
