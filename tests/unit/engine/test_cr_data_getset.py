...
class TestCRCommandsBase(TestCase):
    ...
    def test_add_one_key_to_mod_list(self):
        ...
        cr_cmd.data.writes[0].add(KEY)

        actual_mods = cr_cmd.data.writes
    ...
    def test_add_many_key_to_mod_list(self):
        ...
        cr_cmd = self._new_cmd()
        cr_cmd.data.writes[0].add(KEY1)
        cr_cmd.data.writes[0].add(KEY2)
    ...
    def test_add_keys_from_different_contract(self):
        ...
        self.assertEqual(cr_cmd1.data.writes, cr_cmd2.data.writes)
        actual_mods = cr_cmd1.data.writes
