...
class TestAtomicSwap(TestCase):
    ...
    def test_redeem(self):
        ...
        # print(self.currency.balance_of(wallet_id=wallet_a)['output'])
        # print(self.currency.balance_of(wallet_id=wallet_b)['output'])
        print('::: approve')
        ...
        self.assertEqual(
            json.loads(default_driver.r.get('atomic_swap:swaps.{}:{}'.format(wallet_b, hashlock)).decode()), {
            	"initiator": "324ee2e3544a8853a3c5a0ef0946b929aa488cbe7e7ee31a0fef9585ce398502",
            	"participant": "a103715914a7aae8dd8fddba945ab63a169dfe6e37f79b4a58bcf85bfd681694",
            	"amount": 100,
            	"token": "currency",
            	"expiration": 1800
            })
