...
if __name__ == '__main__':
    ...
    parser.add_argument('--username', default='seneca_test')
    parser.add_argument('--password', default=random_pw)
    parser.add_argument('--database', default='seneca_test')
    parser.add_argument('--hostname', default='127.0.0.1')
    parser.add_argument('--output-file', default='./test_db_conf.ini')
