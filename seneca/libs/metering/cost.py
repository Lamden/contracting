...
class CostEstimator:
    def __init__(self):
        ...
        self.total_opcodes = 143
        self.costs = {}
        self.relevant_ops = set()
        self.histogram_file = open('opcode.csv', 'w+')
        self.costs_file = open('costs.csv', 'w+')
...
f(*a)
    ...
    def computer_medians(self):
        ...
        self.opcodes = [i for i in range(self.total_opcodes) if i in self.relevant_ops]
        self.medians = [m for idx, m in enumerate(medians) if idx in self.relevant_ops]
